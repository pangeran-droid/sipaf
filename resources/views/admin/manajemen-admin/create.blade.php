    ...
    <div class="col-xl-8 col-lg-9">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="avtar avtar-s bg-light-primary me-3">
                        <i class="ti ti-user-plus text-primary f-20"></i>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 f-12">
                            Lengkapi data administrator yang akan dibuat.
                        </p>
            ...
            <div class="card-body">
                ...
                <form
                    action="{{ route('admin.manajemen-admin.store') }}"
                    method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">
                            Gunakan password yang aman untuk akun administrator.
                        </small>
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">
                            Admin Jurusan terkait dengan satu jurusan, sedangkan Super Admin tidak memerlukan jurusan.
                        </small>
